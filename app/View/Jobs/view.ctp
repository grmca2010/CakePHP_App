...
<h3><?php echo $job['Job']['title']; ?></h3>
			<ul>
				...
				<li><strong>Contact Email:</strong> <a href="<?php echo $job['Job']['contact_email']; ?>?Subject=Job%20Applicant" target="_top"><?php echo $job["Job"]["contact_email"]; ?></a></li>
			</ul>
			<p><a href="<?php echo $this->webroot; ?>jobs/browse">Back To Jobs</a></p>

<?php
 if($userData['id'] == $job['Job']['user_id']) :
 ?>
	<br><br>
